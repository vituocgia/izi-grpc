...
from izi_grpc import exceptions, utils
from izi_grpc.config import Config, ConfigAttribute
from izi_grpc.datatypes import ImmutableDict, ConstantsObject
...
class BaseApp:
    ...
    def logger(self):
        logger = logging.getLogger('izi_grpc.app')
    ...
    def load_middlewares(self):
        mids = ['izi_grpc.middleware.GuardMiddleware'] + \
